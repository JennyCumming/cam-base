...
Upgraded the Cambridge Theme to [1.21] (https://github.com/misd-service-development/drupal-cambridge-theme/releases/tag/7.x-1.21)

The following modules have been added to the Profile:

Added A11y [1.1] (https://www.drupal.org/project/a11y/releases/7.x-1.1)
Added Disable Messages [1.2] (https://www.drupal.org/project/disable_messages/releases/7.x-1.2)
Added EU Cookie Compliance [1.37] (https://www.drupal.org/project/eu_cookie_compliance/releases/7.x-1.37)
Added Fast Token Browser [1.5] (https://www.drupal.org/project/fast_token_browser/releases/7.x-1.5)
Added Masquerade [1.0-rc7] (https://www.drupal.org/project/masquerade/releases/7.x-1.0-rc7)
Added Module Missing Message Fixer [1.8] (https://www.drupal.org/project/module_missing_message_fixer/releases/7.x-1.8)
Added Schema Metatag [1.4] (https://www.drupal.org/project/schema_metatag/releases/7.x-1.4)
Added Site Improve [1.3] (https://www.drupal.org/project/siteimprove/releases/7.x-1.3)
Added Views URL Alias [1.0] (https://www.drupal.org/project/views_url_alias/releases/7.x-1.0)
Added Webform Country List [1.5] (https://www.drupal.org/project/webform_country_list/releases/7.x-1.5)

The following custom modules have been added to the Profile:

Added Cam Tokens [1.0] (https://gitlab.developers.cam.ac.uk/uis/webcms/drupal-modules/cam_tokens/-/tags/1.0)
Added Cambridge Paragraphs [1.0] (https://gitlab.developers.cam.ac.uk/uis/webcms/drupal-7-features/cambridge-paragraphs/-/archive/1.0/cambridge-paragraphs-1.0.tar.gz)

The following modules have security upgrades:

Upgraded Link to [1.11] (https://www.drupal.org/project/link/releases/7.x-1.11)
Upgraded Role Delegation to [1.3] (https://www.drupal.org/project/role_delegation/releases/7.x-1.3)

The following modules have been upgraded with maintenance or scheduled releases:

Upgraded Administration Views to [1.8] (https://www.drupal.org/project/admin_views/releases/7.x-1.8)
Upgraded Calendar to [3.6] (https://www.drupal.org/project/calendar/releases/7.x-3.6)
Upgraded CTools to [1.20] (https://www.drupal.org/project/ctools/releases/7.x-1.20)
Upgraded Date to [2.12] (https://www.drupal.org/project/date/releases/7.x-2.12)
Upgraded Entity API to [1.10] (https://www.drupal.org/project/entity/releases/7.x-1.10)
Upgraded Facet API to [1.9] (https://www.drupal.org/project/facetapi/releases/7.x-1.9)
Upgraded Field Collection to [1.2] (https://www.drupal.org/project/field_collection/releases/7.x-1.2)
Upgraded File Entity to [2.36] (https://www.drupal.org/project/file_entity/releases/7.x-2.36)
Upgraded Markup to [1.3] (https://www.drupal.org/project/markup/releases/7.x-1.3)
Upgraded Media to [2.28] (https://www.drupal.org/project/media/releases/7.x-2.28)
Upgraded Media YouTube to [3.10] (https://www.drupal.org/project/media_youtube/releases/7.x-3.10)
Upgraded Menu Block to [2.9] (https://www.drupal.org/project/menu_block/releases/7.x-2.9)
Upgraded Metatag to [1.28] (https://www.drupal.org/project/metatag/releases/7.x-1.28)
Upgraded Redirect to [1.0-rc4] (https://www.drupal.org/project/redirect/releases/7.x-1.0-rc4)
Upgraded RESTful Web Services to [2.9] (https://www.drupal.org/project/restws/releases/7.x-2.9)
Upgraded Rules to [2.13] (https://www.drupal.org/project/rules/releases/7.x-2.13)
Upgraded Search API to [1.28] (https://www.drupal.org/project/search_api/releases/7.x-1.28)
Upgraded Search API DB to [1.8] (https://www.drupal.org/project/search_api_db/releases/7.x-1.8)
...
Upgraded Webform to [4.23] (https://www.drupal.org/project/webform/releases/7.x-4.24)

The following modules were patched:

Paragraphs was patched with (https://www.drupal.org/files/issues/2018-03-08/deprecated_each-2951390-2.patch)
